...
import 'package:stop_complaint/un_available.dart';
import 'home.dart';
import 'login.dart';
...
class StateHome extends State<Awaiting> with TickerProviderStateMixin {
  int curDrwSel = 0;
...
String address="";
  ...
  Future<String> getPosts1() async {
    ...
    var jsonResponse = await http.get(Uri.parse("https://meatbite.in/delivery/awaitingtotal.php?ids="+ids.toString()));
  ...
  getData2() async {
    ...
    var response = await http.get(
        Uri.parse("https://meatbite.in/delivery/awaitorder.php?ids="+ids.toString()),
        headers: {
    ...
    this.setState((){
      ...
      //quantity=int.parse(data![0]['total'].toString());
      quantity=prefs.getString('Dusername');
      address=prefs.getString('Dname')!;
...
else if(statusList[index].toString()=='Un Available')
  {
    Navigator.push(
        context,
        MaterialPageRoute(
  ...
  Future<Null> getOrder() async {
    ...
    if (_isNetworkAvail) {
      ...
      SharedPreferences pref=await SharedPreferences.getInstance();
       ...
       // Response response =await http.get(Uri.parse('https://stoptobacco.in/android/open_complaints.php?ids='+pref.getString('Dname').toString()), headers: headers)
        Response response =await http.post(Uri.parse('https://stoptobacco.in/android/officer/complaints.php?Cdistrict='+pref.getString('Dname').toString()),body: parameter, headers: headers)
  ...
  Future<Null> getUserDetail() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        Response response =
            await post(Uri.parse('https://stoptobacco.in/android/open_complaints.php?ids='+CUR_USERID.toString()), body: parameter, headers: headers)
                .timeout(Duration(seconds: timeOut));

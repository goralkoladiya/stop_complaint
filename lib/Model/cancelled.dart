...
class StateHome extends State<Cancelled> with TickerProviderStateMixin {
  int curDrwSel = 0;
...
String address="";
  ...
  Future<String> getPosts1() async {
    ...
    var jsonResponse = await http.get(Uri.parse("https://meatbite.in/delivery/canceltotal.php?ids="+ids.toString()));
  ...
  getData2() async {
    ...
    var response = await http.get(
        Uri.parse("https://meatbite.in/delivery/cancelorder.php?ids="+ids.toString()),
        headers: {
...
SharedPreferences pref=await SharedPreferences.getInstance();
        Response response =await http.post(Uri.parse('https://meatbite.in/delivery/soldproduct_cancel.php?ID='+pref.getString('Eroute').toString()),body: parameter, headers: headers)
  ...
  Future<Null> getUserDetail() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        Response response =
            await post(Uri.parse('https://meatbite.in/delivery/cancelledproduct.php?ID='+CUR_USERID.toString()), body: parameter, headers: headers)
                .timeout(Duration(seconds: timeOut));

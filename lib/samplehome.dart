...
String address="";
  ...
  Future<String> getPosts1() async {
    ...
    var ids=prefs!.getString('Eid');
    var jsonResponse = await http.get(Uri.parse("https://meatbite.in/delivery/hometotal.php?ids="+ids.toString()));
  ...
  getData2() async {
    ...
    if(ids==null)
    {
      ...
      ids=prefs.getString('Eid');
      quantity=prefs.getString('Eroute');
      address=prefs.getString('Eaddress')!;
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Padding(
                                                  ...
                                                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: <
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Text(orderList![index]['OrderId'].toString()),
                                                          const Spacer(),
                                                          InkWell(
                                                            child: Row(
                                                              children: [
                                                    ...
                                                    new FutureBuilder(
                                                      future: http.get(Uri.parse("https://meatbite.in/delivery/soldpro.php?ids="+orderList![index]['OrderId'].toString())),
                                                      builder: (BuildContext context, AsyncSnapshot<http.Response> response)
                                                      {
                                                        if (!response.hasData) {
                                                          ...
                                                          List<dynamic> json1 =jsonDecode(response.data!.body.toString());
                                                          if(response.data!.body.isNotEmpty) {
                                                            json1 =jsonDecode(response.data!.body);
                                                          }
                                                         // var numberList = [for (var i = 1; i <= json.length; i++) i];
                                                          //return new MyExpansionTileList(json);
                                                          //return new MyExpansionTileList(json);
                                                          return ListView.builder(
                                                              shrinkWrap: true,
                                                              physics: NeverScrollableScrollPhysics(),
                                                              itemCount: json1 == null ? 0 : json1.length,
                                                              itemBuilder: (context, index) {
                                                                return Padding(
                                                                  padding:
                                                                        ...
                                                                        child: Row(
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                json1![index]['Quantity']+" "+json1[index]['Unit'],
                                                                                maxLines: 1,
                                                                                overflow: TextOverflow.ellipsis,
                                                                              ),
                                                                            ),
                                                    ...
                                                    new FutureBuilder(
                                                      future: http.get(Uri.parse("https://meatbite.in/delivery/totalpro.php?ids="+orderList![index]['OrderId'])),
                                                      builder: (BuildContext context, AsyncSnapshot<http.Response> response)
                                                      {
                                                        if (!response.hasData) {
                                                          return const Center(
                                                          ...
                                                          List<dynamic> json2 =jsonDecode(response.data!.body.toString());
                                                          if(response.data!.body.isNotEmpty) {
                                                            json2 =jsonDecode(response.data!.body);
                                                          }
                                                          // var numberList = [for (var i = 1; i <= json.length; i++) i];
                                                          //return new MyExpansionTileList(json);
                                                          //return new MyExpansionTileList(json);
                                                          return ListView.builder(
                                                              ...
                                                              itemBuilder: (context, index) {
                                                               // return Padding(
                                                                  //padding:const EdgeInsets.symmetric(horizontal: 015.0, vertical: 5),
                                                                return Padding(
                                                                  padding:
                                                                  const EdgeInsets.symmetric(horizontal: 8.0, vertical: 5),
                                                                  child: Row(
                                                                    children: [
                                                                     ...
                                                                     /*Flexible(
                                                                      ...
                                                                      /* await Navigator.push(
                                                                            context,
                                                                            MaterialPageRoute(
                                                                                builder: (context) => OrderDetail(orderid:json2![index]['OrderId'],uid:json2![index]['Uid'],
                                                                                    sid:json2![index]['SoldId'],grandtotal:json2![index]['Grandtotal'],

                                                                                    timeslot:json2![index]['Timeslot'],

                                                                                    //orderdate:json1![index]['Orderdate'],
                                                                                    phone:json2![index]['Uphone'],saddress:json2![index]['Uaddress'],landmark:orderList![index]['Ulandmark'],
                                                                                    sname:json2![index]['Uname'],slocation:json2![index]['Ulocation'],area:json2![index]['Uarea'],
                                                                                    pincode:json2![index]['Upincode'],busname:json2![index]['Ubusname'],city:json2![index]['Ucity']
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Text(" Order on: ${orderList![index]['Timeslot']}"),
                                                        ],
                                                      ),
                                                    )*/
                                                  ])),
      ...
      //)
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: const <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
              icon: Icon(Icons.delivery_dining,size:30,color: Colors.white),
              label: 'Undelivered',
            ),
            BottomNavigationBarItem(
          ...
          child: ListView(
            ...
            children: <Widget>[
             ...
             // _getDrawerItem(0, HOME_LBL, Icons.home_outlined),
              _getDrawerItem(0, HOME_LBL, Icons.home),
          ...
          children: [
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: Image.network("https://meatbite.in/uploads/executive/"+pref.getString("Ephoto").toString()),
  ...
  Widget noInternet(BuildContext context) {
   ...
   Future<void> getOrder() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(pref.getString('Eroute') ?? 'No route found'),
      duration: Duration(seconds: 2),
      )
    );
    // Fluttertoast.showToast(msg: pref!.getString('Eroute').toString());
    _isNetworkAvail = await isNetworkAvailable();
    if (_isNetworkAvail) {
      if (offset == 0) {
        orderList = [];
      ...
      try {
        ...
        Response response =await http.post(Uri.parse('https://meatbite.in/delivery/soldproduct2.php?ID='+pref.getString('Eroute').toString()),body: parameter, headers: headers)
                .timeout(Duration(seconds: timeOut));

        orderList = json.decode(response.body.toString());


       // Fluttertoast.showToast(msg: orderList.toString());
    ...
    if (_isNetworkAvail) {
      try {
       SharedPreferences pref=await SharedPreferences.getInstance();
        ...
        var parameter = {ID: pref.getString('Eroute')};
        Response response =
            await post(Uri.parse('https://meatbite.in/delivery/soldproduct1.php?ID='+pref.getString('Eroute').toString()), body: parameter, headers: headers)
                .timeout(Duration(seconds: timeOut));
            ...
            child:
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    //Text("Order No.${model.id!}"),
                    Text("Order No."+orderList![index]['OrderId'].toString()+" sequence: "+orderList![index]['Usequence'].toString()),
                    const Spacer(),
                    Container(
                      margin: const EdgeInsets.only(left: 8),
                      padding:
...
orderList.clear();*/
  ...
  _launchCaller(index) async {
    var url = "tel:${orderList![index]['Uphone']}";
  ...
  _launchCaller1(index) async {
    var url = "${orderList![index]['Ulocation']}";
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';

...
class StateDelivery extends State<Home> with TickerProviderStateMixin {
  int curDrwSel = 0;
  ...
  void initState() {
    ...
    getOrder();
    //getUserDetail();
    final screenWidth = deviceWidth ?? 360.0;
...
orderList.clear();*/
  ...
  _launchCaller(index) async {
    var url = "tel:${orderList![index]['Rphon']}";
  ...
  //   // var url = "${orderList![index]['Clocation']}";
  //   var url = Uri.parse(orderList![index]['Clocation'].toString());
  //   if (await canLaunchUrl(url)) {
  //     await launchUrl(url);
  //   } else {throw 'Could not launch $url';
  //   }
  // }
  void _launchCaller1(int index) async {
    // var url = "${orderList![index]['Clocation']}";
    try{
      var rawLocation = orderList![index]['Clocation'].toString();
      String urlString;
      if(rawLocation.startsWith("https://")){
        urlString = rawLocation as String;

      }else{
        urlString = 'https://maps.google.com/?daddr=$rawLocation';
      }
